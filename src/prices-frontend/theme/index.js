...
export const createTheme = (mode) => {
    const base = ct({
        ...
        typography: {
            ...
            fontFamilyAlt: '"Cantarell",-apple-system, BlinkMacSystemFont, Roboto, "Segoe UI", "Fira Sans", Avenir, "Helvetica Neue", "Lucida Grande", sans-serif',
                  ...
                  components: {
                      MuiCssBaseline: {
                          styleOverrides: {
                              ...
                              ".next-error-h1": {
                                  borderRight: `1px solid ${alpha(base.palette.text.primary, 0.3)} !important`,
                              },
                          },
                      },
                  },
