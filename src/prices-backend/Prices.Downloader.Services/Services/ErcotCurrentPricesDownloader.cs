...
public class ErcotCurrentPricesDownloader : ErcotPricesFileDownloader, ICurrentPricesDownloader
{
    private readonly IPricesFileProcessor? _processor;
    private readonly IDbContextFactory<PricesContext> _contextFactory;
    private readonly ILogger<ErcotCurrentPricesDownloader> _logger;
    private PriceIndex? _priceIndex;

    public ErcotCurrentPricesDownloader(IAzureBlobStorageClientFactory azureBlobStorageClientFactory, IDbContextFactory<PricesContext> contextFactory,
        IPricesFileProcessorFactory pricesFileProcessorFactory, ILogger<ErcotCurrentPricesDownloader> logger, IOptions<Settings> settings)
    ...
    public sealed override Rtos RegionalTransmissionOperator => Rtos.ERCOT;
