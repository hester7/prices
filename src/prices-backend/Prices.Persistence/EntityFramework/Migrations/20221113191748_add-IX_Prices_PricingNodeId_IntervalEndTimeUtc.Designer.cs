...
namespace Prices.Persistence.EntityFramework.Migrations
{
    ...
    [Migration("20221113191748_add-IX_Prices_PricingNodeId_IntervalEndTimeUtc")]
    partial class addIX_Prices_PricingNodeId_IntervalEndTimeUtc
    {
            ...
            modelBuilder.Entity("Prices.Core.Domain.Models.Price", b =>
                {
                    ...
                    b.HasIndex(new[] { "PricingNodeId", "IntervalEndTimeUtc" }, "IX_Prices_PricingNodeId_IntervalEndTimeUtc");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex(new[] { "PricingNodeId", "IntervalEndTimeUtc" }, "IX_Prices_PricingNodeId_IntervalEndTimeUtc"), new[] { "PriceIndexId", "LmpPrice" });
            ...
            modelBuilder.Entity("Prices.Core.Domain.Models.PricingNode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAtUtc = NodaTime.Instant.FromUnixTimeTicks(16683670681382004L),
                            DisplayName = "NP15",
                            LastModifiedAtUtc = NodaTime.Instant.FromUnixTimeTicks(16683670681382004L),
