...
namespace Prices.Core.Application.Extensions
{
    public static class NodaTimeExtensions
    {
        ...
        public static DateTime InZone(this DateTime dateTime, Rtos rto) => InZone(dateTime, TimeZoneHelper.GetIanaTimeZoneId(rto));

        public static Instant RoundUp(this Instant instant, TimeSpan d) => Instant.FromUnixTimeTicks((instant.ToUnixTimeTicks() + d.Ticks - 1) / d.Ticks * d.Ticks);
    }
}
